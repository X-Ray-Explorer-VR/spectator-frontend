...
export default function XRayExplorer() {
  ...
  const parseMessage = useCallback(
    async (message: string) => {
      ...
      } else if (message.startsWith("Oculus client: Question ")) {
        const data = message.replace("Oculus client: Question ", "").trim();

        setQuestion({
          question: data,
          response: "",
        });
      } else if (message.startsWith("Oculus client: QuestionResponse ")) {
        const data = message
          .replace("Oculus client: QuestionResponse ", "")
          .trim();
      ...
      } else if (message.startsWith("Oculus client: QuestionRemove")) {
        setQuestion({
          question: "",
          response: "",
        });
